<script>
    ...
    let postData = {
        ...
        description: "This post resonated well with your audience, sparking meaningful interactions and discussions.",
    ...
    function initPerformanceChart() {
        if (chartCanvas && typeof Chart !== 'undefined') {
            ...
            const labels = ['1W Ago', '', '', '2W Ago', '', '', '3W Ago', '', '', '4W Ago', '', ''];
...
<div class="container py-4">
    ...
    <nav class="mb-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/posts" class="text-decoration-none text-muted">Posts</a></li>
    ...
    <!-- Comments and Shares -->
    <div class="mb-4">
        <h3 class="h5 mb-3">Comments and Shares</h3>
        <div class="row g-3">
            <div class="col-md-6">
                <div class="d-flex align-items-center">
                    <div class="me-3">
                        <i class="fas fa-comment text-primary" style="font-size: 1.2rem;"></i>
                    </div>
                    <div>
                        <div class="fw-bold">{postData.comments}</div>
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-center">
                    <div class="me-3">
                        <i class="fas fa-share text-primary" style="font-size: 1.2rem;"></i>
                    </div>
                    <div>
                        <div class="fw-bold">{postData.shares}</div>
